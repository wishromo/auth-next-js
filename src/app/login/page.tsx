            ...
            <div className="w-full max-w-sm border border-slate-700 rounded-xl p-6 bg-slate-800/50 backdrop-blur-sm shadow-xl flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className="w-full px-3 py-2 rounded-lg bg-slate-900 border border-slate-700 text-white focus:outline-none focus:ring-2 focus:ring-amber-400"
                    />
                </div>
                ...
                <button
                    ...
                    className="w-full py-2 rounded-lg bg-amber-500 text-black font-bold disabled:opacity-50 flex items-center justify-center gap-2"
                >
                    {loading && (
